...
public class Field<G> implements org.jrimum.texgit.type.Field<G> {
	...
	public String toString() {
		...
		return format("Field [name=\"%s\", value=\"%s\", isBlankAccepted=%s, formatter=%s]", Objects.whenNull(this.name, StringUtils.EMPTY), Objects.whenNull(this.value, StringUtils.EMPTY),
				Objects.whenNull(this.isBlankAccepted(), StringUtils.EMPTY), Objects.whenNull(this.formatter, StringUtils.EMPTY));
